...
public partial class TeacherCourseDetailsView : UserControl
{
    ...
    public void Initialize(CourseDto course)
    {
        ...
        _presenter.SessionStartRequested += Presenter_SessionStartRequested;
    ...
    private void StartSessionButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        _presenter.HandleStartSessionRequested(_currentCourse);
    }
    ...
    private void Presenter_SessionStartRequested(object? sender, string message)
    {
        StatusNoticeText.Text = message;
    }
}